...
# 200709 - VS - Scan all valid rows in the sheet instead of shutting down after the first blank line.
...
print()
print("CAPSTONE Individual Contribution Spreadsheet Autograder v2.0")
